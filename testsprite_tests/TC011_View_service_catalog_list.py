...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the application on the correct port: http://localhost:8084/login and wait for the login form to appear.
        await page.goto("http://localhost:8084/login")
        
        # -> Fill the email and password fields and submit the login form by clicking 'Entrar no Sistema'.
        ...
        # -> Wait for the SPA to finish loading, then click the 'Serviços' navigation link and verify the service list or an empty state is displayed.
        frame = context.pages[-1]
        # Click element
