...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the application on the correct server port (http://localhost:8084/login) so the login form can load.
        await page.goto("http://localhost:8084/login")
        
        # -> Fill the email field with dnadirlene@gmail.com, then fill the password, then click 'Entrar no Sistema' to submit the login form.
