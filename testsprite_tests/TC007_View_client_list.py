...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the provided username as the immediate action.
        ...
        # -> Click the 'Clientes' sidebar link to open Client Management and then verify that a client list or an empty-state message is displayed.
        frame = context.pages[-1]
        # Click element
