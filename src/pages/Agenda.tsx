...
export default function Agenda() {
  ...
  console.log('Agenda - Todos agendamentos:', todosAgendamentos);
  console.log('Agenda - Agendamentos filtrados:', agendamentosFiltrados);
  console.log('Agenda - Loading:', loading);
  ...
  const totalReceita = agendamentosHoje.reduce((total, ag) => 
    ag.status === 'concluido' ? total + (Number(ag.valor) || 0) : total, 0
  );
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Total de {todosAgendamentos?.length || 0} agendamentos
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-orange-700 dark:text-orange-300">
                    {metaMensal > 0 ? Math.round((proximosSete.length / metaMensal) * 100) : 0}%
                  </p>
