...
import { Calendar, CalendarDays, CalendarRange, Clock, Plus, Filter, Search, X } from 'lucide-react';
...
import { BuscaClienteHistorico } from '@/components/agenda/ClienteHistorico';
...
export default function Agenda() {
  ...
  const { agendamentos, loading, todosAgendamentos, clientes } = useAgendamentos();
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
              ...
              <div className="flex flex-col gap-4 w-full lg:w-auto">
                ...
                <div className="relative">
                  ...
                  <Input
                    placeholder="Buscar cliente para ver histórico..."
                    value={buscaTexto}
                    onChange={(e) => {
                      setBuscaTexto(e.target.value);
                      if (!e.target.value) setClienteSelecionado(null);
                    }}
                    className="pl-10 pr-10 w-full lg:w-72 bg-background/80 backdrop-blur-sm border-border/50"
                  />
                  {buscaTexto && (
                    <Button
                      variant="ghost"
