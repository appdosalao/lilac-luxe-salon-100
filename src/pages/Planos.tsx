      ...
      <div className="container mx-auto py-12 px-4 max-w-6xl">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground text-lg">
            7 dias grátis • Cancele quando quiser • Acesso completo
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="shadow-xl">
            <CardHeader>
              <div className="flex items-start justify-between gap-4">
                ...
                <Badge variant="outline" className="border-primary/20">Mais Flexível</Badge>
              </div>
            </CardHeader>
          ...
          <Card className="shadow-xl border-2 border-yellow-500/40 bg-gradient-to-b from-yellow-500/5 to-background">
            <CardHeader>
              <div className="flex items-start justify-between gap-4">
                <div>
            ...
            <CardContent className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mt-2">pagamento único • 7 dias grátis</p>
                <p className="text-sm font-medium mt-2 text-yellow-700 dark:text-yellow-300">
                  Economize mais de R$ 250 no primeiro ano
                </p>
              </div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  '7 dias grátis para testar',
                  'Licença permanente e intransferível',
                ].map((text) => (
                  <div key={text} className="flex items-start gap-2">
                    <Check className="h-4 w-4 text-green-600 mt-0.5" />
                    <span className="text-sm">{text}</span>
        ...
        <div className="mt-8 max-w-4xl mx-auto">
          ...
          <div className="text-center text-xs text-muted-foreground mt-4">
            🔒 Pagamento 100% seguro via Asaas • Os 7 dias grátis começam após o cadastro
          </div>
        </div>
      </div>
    </div>
